...
---
{
  (p('client.bapiName.Account-Update')): {
    "import": {
      ...
      "I_CUS": {
        ...
        "BRSCH": payload.Ramo_c__c replace "ELIMINAR" with "",
      ...
      "I_CUSX": {
        ...
        "BRSCH": if(!isEmpty(payload.Ramo_c__c)) "X" else "",
    ...
    "tables": {
      "TI_DVENTAS": {
        "row": {
          ...
          "SPART": "00",
          "KDGRP": payload.Grupo_de_cliente__c replace "ELIMINAR" with "",
          ...
          "KLABC": payload.Clasificaci_n_ABC__c replace "ELIMINAR" with "",
      ...
      "TI_DVENTASX": {
        "row": {
          ...
          "SPART": "X",
          "KDGRP": if(!isEmpty(payload.Grupo_de_cliente__c)) "X" else "",
          ...
          "KLABC": if(!isEmpty(payload.Clasificaci_n_ABC__c)) "X" else "",
